# Generated by Powerlevel10k configuration wizard on 2026-09-21 at 23:09 PDT.
...
#
# Config for Powerlevel10k with classic (Catppuccin Mocha) prompt style: the wizard layout
# above, recolored with the catppuccin-powerlevel10k-themes classic-mocha palette.
# Don't re-run `p10k configure`: it overwrites ~/.p10k.zsh (the loader) with stock colors.
#
